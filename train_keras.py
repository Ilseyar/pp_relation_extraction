...
pretrained_embeddings_file = '/media/ilseyar/Disk_D/Ilseyar/Projects/vectors/PubMed-w2v.bin'
...
category_keys = [k[0] for k in sorted(categories.items(), key=lambda x: x.v)]
...
def main():
    ...
    for fold_id in range(10):
        ...
        train_file = "data/AiMed/folds/" + str(fold_id) + "/train.txt"
        test_file = "data/AiMed/folds/" + str(fold_id) + "/test.txt"
